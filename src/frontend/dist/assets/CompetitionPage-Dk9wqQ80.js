import { c as createLucideIcon, r as reactExports, j as jsxRuntimeExports, s as shimExports, e as cn, R as React2, u as useComposedRefs, a as reactDomExports, B as Button, T as Trophy } from "./index-DZE4_1XK.js";
import { u as useCallbackRef, d as useLayoutEffect2, b as createContextScope$1, e as createSlot, P as Primitive$1, f as useControllableState, g as useId, c as composeEventHandlers, h as Portal$1, i as hideOthers, j as useFocusGuards, R as ReactRemoveScroll, F as FocusScope, D as DismissableLayer, k as Presence } from "./index-DL_KEFUS.js";
import { P as Primitive } from "./index-CWGPi081.js";
import { u as useDirection, c as clamp$1, S as ScrollArea } from "./scroll-area-DEiXEbPY.js";
import { u as useSize, a as usePrevious, S as Star } from "./index-BLA2Xjot.js";
import { a as ChevronDown, C as ChevronUp } from "./chevron-up-NwpvRlDh.js";
import { k as SAMPLE_LEADERBOARD, i as SAMPLE_PROFILE, L as Layout, l as SAMPLE_COMPETITION, C as ChallengeType } from "./sample-data-B2VD8r3E.js";
...
const COMPETITION_USERNAMES = {
  1: "BlazeTerraform",
  2: "NightStrider99",
  3: "PacificRunner"
};
const COMPETITION_LOCATIONS = {
  1: "San Francisco, CA",
  2: "Oakland, CA",
  3: "San Jose, CA"
};
...
function useCountdown(endsAt) {
  const endMs = Number(endsAt / 1000000n);
  const [remaining, setRemaining] = reactExports.useState(Math.max(0, endMs - Date.now()));
  reactExports.useEffect(() => {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            ...
            children: /* @__PURE__ */ jsxRuntimeExports.jsx(Trophy, { className: "w-9 h-9", style: { color: "oklch(0.10 0 0)" } })
          }
        )
      ]
    }
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          Avatar,
          {
            className: "w-11 h-11",
            style: {
              border: rank === 1 ? "2px solid oklch(0.72 0.2 72 / 0.6)" : void 0
            },
            children: /* @__PURE__ */ jsxRuntimeExports.jsx(
              AvatarFallback,
              {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center min-w-0 w-full", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-semibold text-xs truncate text-foreground", children: username }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[10px] text-muted-foreground truncate", children: location }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "p",
            {
...
function StandingsRow({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    motion.div,
    {
      ...
      style: {
        background: isCurrentUser ? "oklch(0.72 0.2 72 / 0.1)" : "oklch(0.15 0.006 50)",
        border: `1px solid ${isCurrentUser ? "oklch(0.72 0.2 72 / 0.3)" : "oklch(0.22 0.01 50)"}`
      },
      "data-ocid": `competition.standings.item.${index2 + 1}`,
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "span",
          {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(Avatar, { className: "w-8 h-8 shrink-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
          AvatarFallback,
          {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-sm font-medium truncate text-foreground", children: [
            username,
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground truncate", children: location })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-sm font-semibold tabular-nums shrink-0 text-foreground", children: [
          score.toFixed(1),
          " km²"
        ] })
      ]
    ...
    motion.div,
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground truncate", children: entry.locationLabel })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-sm font-semibold tabular-nums shrink-0 text-foreground", children: [
          entry.totalTerritoryArea.toFixed(1),
          " km²"
        ] })
      ]
    }
...
function CompetitionPage() {
  ...
  const filteredLeaderboard = locationFilter === "all" ? EXTENDED_LEADERBOARD : EXTENDED_LEADERBOARD.filter((e) => e.locationLabel === locationFilter);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Layout, { headerTitle: "Competition", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
          ...
          motion.div,
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-2xl font-display font-bold text-foreground", children: "Competition" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground mt-0.5", children: "Monthly territory battles" })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(CompetitionBadge, {})
            ]
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "div",
                    {
                      ...
                      style: {
                        background: "linear-gradient(90deg, oklch(0.72 0.2 72), oklch(0.75 0.22 60), oklch(0.72 0.2 72))"
                      }
                    }
                  ),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-4", children: [
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "text-xl font-display font-bold text-foreground", children: [
                      competition.monthYear,
                      " Challenge"
                    ] }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground mt-0.5", children: formatChallengeType(competition.challengeType) }),
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-4", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground uppercase tracking-wide mb-2", children: "Time Remaining" }),
                      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-2", children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx(CountdownUnit, { value: days, label: "days" }),
                        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xl font-bold text-muted-foreground mt-3", children: ":" }),
                        /* @__PURE__ */ jsxRuntimeExports.jsx(CountdownUnit, { value: hours, label: "hrs" }),
                        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xl font-bold text-muted-foreground mt-3", children: ":" }),
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-4", children: !isJoined ? /* @__PURE__ */ jsxRuntimeExports.jsx(
                      Button,
                      {
                        type: "button",
                      ...
                      "div",
                      {
                        ...
                        children: "✓ You're competing this month"
                      }
                    ) })
                  ] })
                ]
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          motion.div,
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "text-base font-display font-semibold text-foreground mb-3 flex items-center gap-2", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  Crown,
                  {
                    className: "w-4 h-4",
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "div",
                {
                  ...
                  children: prizes.map((p, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    "div",
                    {
                      className: "flex items-center gap-3 px-4 py-3",
                      style: {
                        borderBottom: i < prizes.length - 1 ? "1px solid oklch(0.22 0.01 50)" : void 0,
                        borderLeft: i === 0 ? "3px solid oklch(0.72 0.2 72)" : i === 1 ? "3px solid oklch(0.65 0.15 50)" : "3px solid oklch(0.65 0.20 45)"
                      },
                      "data-ocid": `competition.prize.item.${i + 1}`,
                      children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-2xl", children: p.icon }),
                        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground font-medium uppercase tracking-wide", children: p.place }),
                          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-semibold text-foreground", children: p.prize })
                        ] })
                      ]
                    },
                    p.place
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          motion.div,
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "text-base font-display font-semibold text-foreground mb-3 flex items-center gap-2", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(Medal, { className: "w-4 h-4 text-muted-foreground" }),
                "Full Standings"
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                ScrollArea,
                {
                  ...
                  children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-3 space-y-1.5", children: fullStandings.map((s, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                    StandingsRow,
                    {
                      rank: s.rank,
                      username: s.username,
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          motion.div,
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "text-base font-display font-semibold text-foreground mb-3 flex items-center gap-2", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(Star, { className: "w-4 h-4", style: { color: "oklch(0.72 0.2 72)" } }),
                "Territory Leaders"
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs(Tabs, { defaultValue: "global", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs(TabsList, { className: "w-full mb-4", "data-ocid": "leaderboard.tabs", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    TabsTrigger,
                    {
                      value: "global",
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx(TabsContent, { value: "global", className: "mt-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                  ScrollArea,
                  {
                    ...
                    style: { border: "1px solid oklch(0.22 0.01 50)" },
                    children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-3 space-y-1.5", children: EXTENDED_LEADERBOARD.map((entry, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                      LeaderboardRow,
                      {
                        entry,
                        isCurrentUser: entry.username === SAMPLE_PROFILE.username,
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs(TabsContent, { value: "location", className: "mt-0 space-y-3", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    Select,
                    {
                      ...
                      children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx(
                          SelectTrigger,
                          {
                            ...
                            children: /* @__PURE__ */ jsxRuntimeExports.jsx(SelectValue, { placeholder: "Select a location..." })
                          }
                        ),
                        /* @__PURE__ */ jsxRuntimeExports.jsxs(SelectContent, { "data-ocid": "leaderboard.location.dropdown_menu", children: [
                          /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: "all", children: "All Locations" }),
                          allLocations.map((loc) => /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: loc, children: loc }, loc))
                        ] })
                      ]
                    }
                  ),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    ScrollArea,
                    {
                      className: "h-72 rounded-xl",
                      style: { border: "1px solid oklch(0.22 0.01 50)" },
                      children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-3 space-y-1.5", children: filteredLeaderboard.length > 0 ? filteredLeaderboard.map((entry, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                        LeaderboardRow,
                        {
                          entry,
                          isCurrentUser: entry.username === SAMPLE_PROFILE.username,
                        ...
                        "div",
                        {
                          ...
                          children: [
                            ...
                            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-medium text-muted-foreground", children: "No runners found in this location" })
                          ]
                        }
                      ) })
                    }
